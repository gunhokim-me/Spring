...
public class IocTest {
	...
	public void beanScopeTest2() {
		//동일한 스프링빈을 주입받았으므로 userService, userService2는 같은 객체다
		assertEquals(userService, userService2);
	}
	
	@Test
	public void beanScopePrototypeTest() {
		//동일한 userServicePrototype 빈을 주입(scope : prototype) userServicePrototype, userServicePrototype는 같은 객체다
	...
	public void propertyPlaceholderTest() {
		...
		assertEquals("PC01",dbConfig.getUsername());
